...
<head>
    ...
    <title>AdVentas - Sistema Ventas www.pequescloset.com</title>
                    ...
                    <li>
                        ...
                        <ul id="almacen" class="collapse">
                            ...
                            <li>
                             ...
                             <li>
                                <a href="color/index.php" target="contenedor"><i class="fa fa-fw fa-table"></i>Colores</a>
                            </li>
                            <li>
                                <a href="talla/index.php" target="contenedor"><i class="fa fa-fw fa-table"></i>Tallas</a>
                            </li>
                        </ul>
                    </li>
                   ...
                   <?
                    ...
                    <li>
                        ...
                        <ul id="mantenimiento" class="collapse">
                            ...
                            <li>
                                <a href="tipo_cambio/index.php" target="contenedor"><i class="fa fa-fw fa-table"></i>Tipo Cambio</a>
                            </li>
                            <li>
                                <a href="promocion/index.php" target="contenedor"><i class="fa fa-fw fa-table"></i>Promociones</a>
                            </li>
                            <li>
                    ...
                    <li>
                        ...
                        <ul id="herramientas" class="collapse">
                            <li>
                                <a href="clases/myphp-backup.php" target="contenedor"><i class="fa fa-fw fa-table"></i>Respaldar Base de Datos</a>
                            </li>
