...
<div class="wrapper">
<form name="form_tipodoc" method="post" action="guardar_tipocambio.php">
<div class="block">

    <div class="block_head"> 
    	<div class="imagen_head"><img src="../img/header/categoria.png" width="48" height="48"></div>
    <div class="titulo_head">EDITAR TIPO DE CAMBIO</div>
...
$id_tipodoc=$_GET["idtipocambio"];
	
$objtipodoc=new clsTipoCambio;
$resultado=$objtipodoc->consultarTipoCambioPorParametro('id',$id_tipodoc,'');
	
while($row=mysql_fetch_array($resultado)){
	$cod=$row["IdTipoCambio"];
