...
$idtipodoc=$_GET['idtipocambio'];

$objtipocambio = new clsTipoCambio;
$resultado=$objtipocambio->consultarTipoCambioPorParametro('id',$idtipodoc,'');

while($row=@mysql_fetch_array($resultado)){
		$idtipocambio=$row["IdTipoCambio"];
 ...
 <div class="toolbar" id="toolbar">
            <table class="toolbar">
            	<tbody>
                    ...
                    <td>
                    <?php
                        echo "<a class='toolbar' href=editar_tipocambio.php?idtipocambio=".$idtipocambio."><span class='icon-32-editar' title='Editar'>
                        </span>Editar</a>"; ?>
