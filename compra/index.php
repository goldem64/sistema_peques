    ...
    <td>
      ...
      <div class="box_1">
        <table width="100%" border="0">
          ...
          <tr>
            <td><input type="hidden" name="txtIdProveedor" value="<?php echo $idproveedor ?>"><input name="txtNomProv" type="text" disabled size="35" value="<?php echo $nomproveedor ?>">&nbsp;&nbsp;&nbsp;<a href="#myprov" rel="leanModal" name="myprov" class="button_p" title="Buscar producto"><img src="../img/icon/buscar_detalle.png"></a></td>
            </tr>
          <tr>
