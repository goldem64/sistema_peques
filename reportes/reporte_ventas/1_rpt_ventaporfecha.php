...
function enviarPDF()
{
	...
	window.open("1_rpt_pdf_ventaporfecha.php?fechaini="+fi+"&fechafin="+ff,'win2','status=no,toolbar=no,scrollbars=yes,titlebar=no,menubar=no,resizable=yes,width=1000,height=900,directories=no,location=no');
return false;
...
function enviarPrinter()
{
	var fi=document.datos.fechaini.value;
	var ff=document.datos.fechafin.value;
	window.open("1_rpt_printer_ventaporfecha.php?fechaini="+fi+"&fechafin="+ff,'win2','status=no,toolbar=no,scrollbars=yes,titlebar=no,menubar=no,resizable=yes,width=850,height=480,directories=no,location=no');
return false;
