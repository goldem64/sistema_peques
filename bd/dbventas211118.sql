...
--
-- Servidor: localhost
-- Tiempo de generación: 21-11-2018 a las 09:10:55
...
CREATE  PROCEDURE `SP_I_Promocion` (`pcodigo` VARCHAR(50), `pdescuento` DECIMAL(4,2))  BEGIN		
...
CREATE  PROCEDURE `SP_I_Venta` (`pidtipodocumento` INT, `pidcliente` INT, `pidempleado` INT, `pserie` VARCHAR(5), `pnumero` VARCHAR(20), `pfecha` DATE, `ptotalventa` DECIMAL(8,2), `pigv` DECIMAL(8,2), `ptotalpagar` DECIMAL(8,2), `pestado` VARCHAR(30), `ppago` VARCHAR(30), `ppromo` VARCHAR(50), `pdescuento` DECIMAL(8,2), `preferencia` VARCHAR(30))  BEGIN		
...
CREATE  PROCEDURE `SP_U_Promocion` (`pidpromocion` INT, `pcodigo` VARCHAR(50), `pdescuento` DECIMAL(4,2))  BEGIN
...
(1, '00000000001', 'SustanciaX', 'Producto para registro de prueba', '38.00', '1.00', '987.65', '1500.00', '512.35', 'ACTIVO', '1539913725-nuevoProducto.jpg', 1),
(2, '3434', 'prod2', 'aSSADSAD', '98.00', '10.00', '1000.00', '2000.00', '1000.00', 'ACTIVO', '', 1);
...
--
ALTER TABLE `talla`
  MODIFY `IdTalla` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=1;
...
--
ALTER TABLE `promocion`
  MODIFY `IdPromocion` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=1;
--
