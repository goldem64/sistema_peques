...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 18-10-2016 a las 02:15:15
...
CREATE PROCEDURE `SP_I_TipoCambio`(	
			ptipocambio decimal(4,2)
		)
BEGIN		
...
CREATE PROCEDURE `SP_S_COMPRA_TOTAL_DIARIA`()
BEGIN
...
CREATE PROCEDURE `SP_S_INGRESAR_SISTEMA`(n_usuario varchar(20), n_contrasena text)
BEGIN
...
CREATE PROCEDURE `SP_S_TipoCambio`(	
...
CREATE PROCEDURE `SP_S_TipoCambioCantidadTotal`(	
...
BEGIN
	...
	END$$
CREATE PROCEDURE `SP_S_TipoCambioIdMaximo`(	
...
CREATE PROCEDURE `SP_S_TipoCambioPorParametro`(	
			pcriterio varchar(20),
			pbusqueda varchar(20),
			plimit varchar(20)
		)
...
CREATE PROCEDURE `SP_S_VENTA_TOTAL_DIARIA`()
BEGIN
...
BEGIN
	...
	END$$
CREATE PROCEDURE `SP_U_TipoCambio`(	
		   pidtipocambio int,
			ptipocambio decimal(4,2)
		)
BEGIN
...
-- Funciones
--
CREATE FUNCTION `DiaEnLetras`(pfecha DATE
...
(1, 1, 1, 1, '001', 'C0000000001', '2015-04-20', '1416.71', '255.01', '1671.72', 'EMITIDO', 'EFECTIVO',''),
(2, 1, 1, 1, '001', 'C0000000002', '2015-04-20', '33.90', '6.10', '40.00', 'EMITIDO', 'EFECTIVO',''),
(3, 1, 1, 1, '001', 'C0000000003', '2015-04-20', '38.14', '6.87', '45.00', 'EMITIDO', 'EFECTIVO',''),
(4, 1, 1, 1, '001', 'C0000000004', '2015-04-20', '38.14', '6.87', '45.00', 'EMITIDO', 'EFECTIVO',''),
(5, 1, 1, 1, '001', 'C0000000005', '2015-04-20', '1264.17', '227.55', '1491.72', 'EMITIDO', 'EFECTIVO',''),
(6, 1, 1, 1, '001', 'C0000000006', '2015-04-20', '38.14', '6.87', '45.00', 'EMITIDO', 'EFECTIVO',''),
(7, 1, 1, 1, '001', 'C0000000007', '2015-04-21', '103.39', '18.61', '122.00', 'EMITIDO', 'EFECTIVO',''),
(8, 1, 1, 1, '001', 'C0000000008', '2015-04-22', '76.27', '13.73', '90.00', 'EMITIDO', 'EFECTIVO',''),
(9, 1, 1, 1, 'C0000', 'C0000000008', '2015-05-12', '68.50', '18.50', '70.00', 'EMITIDO', 'EFECTIVO',''),
(10, 2, 1, 1, '001', 'C0000000010', '2015-04-23', '114.41', '20.59', '135.00', 'EMITIDO', 'EFECTIVO',''),
(11, 1, 1, 1, '001', 'C0000000011', '2015-04-23', '76.27', '13.73', '90.00', 'EMITIDO', 'EFECTIVO',''),
(12, 1, 1, 1, '001', 'C0000000012', '2015-04-23', '76.27', '13.73', '90.00', 'EMITIDO', 'EFECTIVO',''),
(13, 1, 1, 1, '001', 'C0000000013', '2015-04-23', '152.54', '27.46', '180.00', 'EMITIDO', 'EFECTIVO',''),
(14, 1, 1, 1, '001', 'C0000000014', '2015-04-26', '1.69', '0.30', '2.00', 'EMITIDO', 'EFECTIVO','');
