...
--
-- Servidor: localhost
-- Tiempo de generación: 22-11-2018 a las 17:22:57
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `SP_I_Promocion` (`pcodigo` VARCHAR(50), `pdescuento` DECIMAL(4,2))  BEGIN		
		INSERT INTO promocion(codigo,descuento)
		VALUES(pcodigo,pdescuento);
	END$$
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `SP_I_Venta` (`pidtipodocumento` INT, `pidcliente` INT, `pidempleado` INT, `pserie` VARCHAR(5), `pnumero` VARCHAR(20), `pfecha` DATE, `ptotalventa` DECIMAL(8,2), `pigv` DECIMAL(8,2), `ptotalpagar` DECIMAL(8,2), `pestado` VARCHAR(30), `ppago` VARCHAR(30), `ppromo` VARCHAR(50), `pdescuento` DECIMAL(8,2), `preferencia` VARCHAR(30))  BEGIN		
		INSERT INTO venta(idtipodocumento,idcliente,idempleado,serie,numero,fecha,totalventa,igv,totalpagar,estado,pago,promo,descuento,referencia)
		VALUES(pidtipodocumento,pidcliente,pidempleado,pserie,pnumero,pfecha,ptotalventa,pigv,ptotalpagar,pestado,ppago,ppromo,pdescuento,preferencia);
	END$$
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `SP_S_PromocionPorParametro` (`pcriterio` VARCHAR(20), `pbusqueda` VARCHAR(20), `plimit` VARCHAR(20))  BEGIN
	...
	IF pcriterio = "id" THEN		
			SET @sentencia = CONCAT("SELECT p.IdPromocion,p.Codigo,p.Descuento FROM promocion AS p WHERE p.IdPromocion=",pbusqueda," ORDER BY p.IdPromocion DESC ",plimit);
			PREPARE consulta FROM @sentencia;
			EXECUTE consulta;
		ELSEIF pcriterio = "codigo" THEN
			SET @sentencia = CONCAT("SELECT p.IdPromocion,p.Codigo,p.Descuento FROM promocion AS p WHERE p.Codigo LIKE '",CONCAT("%",pbusqueda,"%"),"'"," ORDER BY p.IdPromocion DESC ",plimit);
			PREPARE consulta FROM @sentencia;
			EXECUTE consulta;	
		ELSE	
			SET @sentencia = CONCAT("SELECT p.IdPromocion,p.Codigo,p.Descuento FROM promocion AS p ORDER BY p.IdPromocion DESC ",plimit);
			PREPARE consulta FROM @sentencia;
			EXECUTE consulta;	
	END IF; 
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `SP_S_VentaPorDetalle` (`pcriterio` VARCHAR(30), `pfechaini` DATE, `pfechafin` DATE)  BEGIN
		...
		ELSEIF pcriterio = "EFECTIVO" THEN
			SELECT p.Codigo,p.Nombre AS Producto,c.Descripcion AS Categoria,dv.Costo,dv.Precio,
			SUM(dv.Cantidad) AS Cantidad,TRUNCATE(SUM(dv.Total)-(SUM(dv.Total)*v.descuento/100),2) AS Total,
			SUM(TRUNCATE((Total-(dv.Costo*dv.Cantidad)),2)) AS Ganancia FROM venta AS v
			INNER JOIN detalleventa AS dv ON v.IdVenta=dv.IdVenta
			INNER JOIN producto AS p ON dv.IdProducto=p.IdProducto
			INNER JOIN categoria AS c ON p.IdCategoria=c.IdCategoria
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `SP_U_Promocion` (`pidpromocion` INT, `pcodigo` VARCHAR(50), `pdescuento` DECIMAL(4,2))  BEGIN
...
(2, 1, '1.00', '987.65', '1500.00', '0.00', '1500.00'),
(3, 1, '1.00', '987.65', '1500.00', '0.00', '1500.00'),
(4, 2, '1.00', '1000.00', '2000.00', '0.00', '2000.00'),
(4, 1, '1.00', '987.65', '1500.00', '0.00', '1500.00'),
(5, 1, '1.00', '987.65', '1500.00', '0.00', '1500.00'),
(6, 2, '1.00', '1000.00', '2000.00', '0.00', '2000.00'),
(6, 1, '1.00', '987.65', '1500.00', '0.00', '1500.00'),
(7, 1, '1.00', '987.65', '1500.00', '0.00', '1500.00'),
(8, 1, '1.00', '987.65', '1500.00', '0.00', '1500.00'),
(9, 1, '1.00', '987.65', '1500.00', '0.00', '1500.00'),
(10, 1, '1.00', '987.65', '1500.00', '0.00', '1500.00'),
(11, 1, '1.00', '987.65', '1500.00', '0.00', '1500.00'),
(12, 1, '1.00', '987.65', '1500.00', '0.00', '1500.00'),
(13, 1, '1.00', '987.65', '1500.00', '0.00', '1500.00'),
(14, 1, '60.00', '987.65', '1500.00', '0.00', '90000.00'),
(15, 1, '1.00', '987.65', '1500.00', '0.00', '1500.00'),
(16, 1, '1.00', '987.65', '1500.00', '0.00', '1500.00'),
(17, 1, '1.00', '987.65', '1500.00', '0.00', '1500.00'),
(18, 1, '1.00', '987.65', '1500.00', '0.00', '1500.00'),
(19, 3, '2.00', '100.00', '300.00', '0.00', '600.00'),
(20, 3, '2.00', '100.00', '300.00', '0.00', '600.00'),
(21, 3, '2.00', '100.00', '300.00', '0.00', '600.00'),
(22, 3, '3.00', '100.00', '300.00', '0.00', '900.00'),
(23, 3, '3.00', '100.00', '300.00', '0.00', '900.00'),
(24, 3, '3.00', '100.00', '300.00', '0.00', '900.00'),
(25, 1, '2.00', '987.65', '1500.00', '0.00', '3000.00'),
(26, 4, '1.00', '400.00', '500.00', '0.00', '500.00');
...
(2, 'Gustavo', 'Rosas', 'M', '1987-04-27', '', '', '9981113869', 'goldem64@yahoo.com.mx', '', '2018-10-01', '25000.00', 'ACTIVO', 'goldem64', 'c3581516868fb3b71746931cac66390e', 1),
(3, 'Javier', 'Hernandezz', 'M', '2000-02-01', '', '', '9981113869', 'fernando@gmail.com', '', '0000-00-00', '5000.00', 'ACTIVO', 'javier', '3c9c03d6008a5adf42c2a55dd4a1a9f2', 2);
...
(1, '00000000001', 'SustanciaX', 'Producto para registro de prueba', '36.00', '1.00', '987.65', '1500.00', '512.35', 'ACTIVO', '1539913725-nuevoProducto.jpg', 1, 1, 1, 1),
(2, '3434', 'prod2', 'aSSADSAD', '98.00', '10.00', '1000.00', '2000.00', '1000.00', 'ACTIVO', '', 1, 1, 1, 1),
(3, '6546546', 'MAMELUCO SPLIT MARINO', 'mameluco sprint', '-5.00', '1.00', '100.00', '300.00', '200.00', 'ACTIVO', '', 1, 2, 4, 2),
(4, '5675655766', 'Mameluco ositos', 'Mameluco bordado', '9.00', '1.00', '400.00', '500.00', '100.00', 'ACTIVO', '', 1, 2, 4, 3);
...
INSERT INTO `promocion` (`IdPromocion`, `Codigo`, `Descuento`) VALUES
(1, 'PSFM50', 50),
(2, 'INA2025', 20);
...
(2, 'COCOM GRAFIC', '45435345', '35345345', 'AKSODSAÑLDKASÑ', '.515156', '5616111616', 'a2le@cancun.com', '1515153', '3513515313', 'ACTIVO', '5313513513 COSA');
...
INSERT INTO `venta` (`IdVenta`, `IdTipoDocumento`, `IdCliente`, `IdEmpleado`, `Serie`, `Numero`, `Fecha`, `TotalVenta`, `Igv`, `TotalPagar`, `Estado`, `Pago`, `Promo`, `Descuento`, `Referencia`) VALUES
(2, 1, 1, 2, '001', 'C0000000001', '2018-11-07', '1293.10', '206.90', '1500.00', 'EMITIDO', 'EFECTIVO', '', '0.00', 'NO APLICA'),
(3, 1, 1, 2, '001', 'C0000000003', '2018-11-07', '1293.10', '206.90', '1500.00', 'EMITIDO', 'EFECTIVO', 'PMDFG20', '20.00', 'NO APLICA'),
(4, 1, 1, 2, '001', 'C0000000004', '2018-11-07', '3017.24', '482.76', '3500.00', 'EMITIDO', 'EFECTIVO', 'PMDFG20', '20.00', 'NO APLICA'),
(5, 1, 1, 2, '001', 'C0000000005', '2018-11-18', '1293.10', '206.90', '1500.00', 'EMITIDO', 'EFECTIVO', 'PMDFG20', '20.00', 'NO APLICA'),
(6, 1, 1, 2, '001', 'C0000000006', '2018-11-18', '3017.24', '482.76', '3500.00', 'EMITIDO', 'EFECTIVO', 'PMDFG20', '20.00', 'NO APLICA'),
(7, 1, 1, 2, '001', 'C0000000007', '2018-11-19', '1293.10', '206.90', '1500.00', 'EMITIDO', 'TARJETA', '0001', '0.00', ''),
(8, 1, 1, 2, '001', 'C0000000008', '2018-11-19', '1293.10', '206.90', '1500.00', 'EMITIDO', 'TARJETA', '0901', '0.00', ''),
(9, 1, 1, 2, '001', 'C0000000009', '2018-11-19', '1293.10', '206.90', '1500.00', 'EMITIDO', 'EFECTIVO', 'PMDFG20', '20.00', 'NO APLICA'),
(10, 1, 1, 2, '001', 'C0000000010', '2018-11-19', '1293.10', '206.90', '1500.00', 'EMITIDO', 'EFECTIVO', 'PMDFG20', '20.00', 'NO APLICA'),
(11, 1, 1, 2, '001', 'C0000000011', '2018-11-19', '1293.10', '206.90', '1500.00', 'EMITIDO', 'TARJETA', '', '0.00', '1200'),
(12, 1, 1, 2, '001', 'C0000000012', '2018-11-19', '1293.10', '206.90', '1500.00', 'EMITIDO', 'TARJETA', '', '0.00', '0001'),
(13, 1, 1, 2, '001', 'C0000000013', '2018-11-19', '1293.10', '206.90', '1500.00', 'EMITIDO', 'TARJETA', 'PMDFG20', '20.00', '0002'),
(14, 1, 1, 2, '001', 'C0000000014', '2018-11-19', '77586.21', '12413.79', '90000.00', 'EMITIDO', 'TARJETA', 'PMDFG20', '20.00', '0003'),
(15, 1, 1, 2, '001', 'C0000000015', '2018-11-20', '1293.10', '206.90', '1500.00', 'EMITIDO', 'TARJETA', 'PMDFG20', '20.00', '002'),
(16, 1, 1, 2, '001', 'C0000000016', '2018-11-20', '1293.10', '206.90', '1500.00', 'EMITIDO', 'TARJETA', 'PMDFG20', '20.00', '1200'),
(17, 1, 1, 2, '001', 'C0000000017', '2018-11-20', '1293.10', '206.90', '1500.00', 'EMITIDO', 'TARJETA', 'PMDFG20', '20.00', '1200'),
(18, 1, 1, 2, '001', 'C0000000018', '2018-11-20', '1293.10', '206.90', '1500.00', 'EMITIDO', 'TARJETA', 'PMDFG20', '20.00', '1200'),
(19, 1, 1, 2, '001', 'C0000000019', '2018-11-22', '517.24', '82.76', '600.00', 'EMITIDO', 'EFECTIVO', 'PSFM50', '50.00', 'NO APLICA'),
(20, 1, 1, 2, '001', 'C0000000020', '2018-11-22', '517.24', '82.76', '600.00', 'EMITIDO', 'TARJETA', 'PSFM50', '50.00', '0001'),
(21, 1, 1, 2, '001', 'C0000000021', '2018-11-22', '517.24', '82.76', '600.00', 'EMITIDO', 'TARJETA', 'PSFM50', '50.00', '0002'),
(22, 1, 1, 2, '001', 'C0000000022', '2018-11-22', '775.86', '124.14', '900.00', 'EMITIDO', 'TARJETA', '', '0.00', '0003'),
(23, 1, 1, 2, '001', 'C0000000023', '2018-11-22', '775.86', '124.14', '900.00', 'EMITIDO', 'EFECTIVO', 'PSFM50', '50.00', 'NO APLICA'),
(24, 1, 1, 2, '001', 'C0000000024', '2018-11-22', '775.86', '124.14', '900.00', 'EMITIDO', 'EFECTIVO', 'PSFM50', '50.00', 'NO APLICA'),
(25, 1, 1, 3, '001', 'C0000000025', '2018-11-22', '2586.21', '413.79', '3000.00', 'EMITIDO', 'EFECTIVO', 'PSFM50', '50.00', 'NO APLICA'),
(26, 1, 1, 2, '001', 'C0000000026', '2018-11-22', '431.03', '68.96', '500.00', 'EMITIDO', 'EFECTIVO', 'PSFM50', '50.00', 'NO APLICA');
