...
CREATE  PROCEDURE `SP_I_DetalleVenta` (`pidventa` INT, `pidproducto` INT, `pcantidad` DECIMAL(8,2), `pcosto` DECIMAL(8,2), `pprecio` DECIMAL(8,2), `pdescuento` DECIMAL(8,2), `ptotal` DECIMAL(8,2))  BEGIN		
...
CREATE  PROCEDURE `SP_I_Venta` (`pidtipodocumento` INT, `pidcliente` INT, `pidempleado` INT, `pserie` VARCHAR(5), `pnumero` VARCHAR(20), `pfecha` DATE, `ptotalventa` DECIMAL(8,2), `pigv` DECIMAL(8,2), `ptotalpagar` DECIMAL(8,2), `pestado` VARCHAR(30), `ppago` VARCHAR(30), `preferencia` VARCHAR(30))  BEGIN		
...
(1, 1, '1.00', '987.65', '1500.00','0.0', '1500.00'),
(2, 1, '5.00', '987.65', '1500.00','0.0', '7500.00'),
(3, 1, '1.00', '987.65', '1500.00','0.0', '1500.00'),
(4, 1, '3.00', '987.65', '1500.00','0.0', '4500.00'),
(5, 1, '1.00', '987.65', '1500.00','0.0', '1500.00'),
(6, 1, '10.00', '987.65', '1500.00','0.0', '15000.00'),
(7, 1, '2.00', '987.65', '1500.00','0.0', '3000.00'),
(8, 1, '1.00', '987.65', '1500.00','0.0', '1500.00'),
(9, 1, '20.00', '987.65', '1500.00','0.0', '30000.00'),
(10, 1, '50.00', '987.65', '1500.00','0.0', '75000.00'),
(11, 1, '2.00', '987.65', '1500.00','0.0', '3000.00'),
(12, 2, '1.00', '890.00', '1350.00','0.0', '1350.00'),
(13, 2, '2.00', '890.00', '1350.00','0.0', '2700.00'),
(13, 1, '1.00', '987.65', '1500.00','0.0', '1500.00'),
(14, 3, '5.00', '200.00', '320.00','0.0', '1600.00');
