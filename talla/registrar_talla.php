...
?>
<div class="wrapper">
    <form action="guardar_talla.php" method="post" name="form1">
<div class="block">
    <div class="block_head"> 
    <div class="imagen_head"><img src="../img/header/talla.png" width="48" height="48"></div>
    <div class="titulo_head">REGISTRAR TALLA</div>
    ...
    <div class="block_content">
        ...
        <legend>Detalle de talla</legend>
