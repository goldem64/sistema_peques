...
?>
<div class="wrapper">
<form name="form1" method="post" action="guardar_talla.php">
<div class="block">

    <div class="block_head"> 
    	<div class="imagen_head"><img src="../img/header/categoria.png" width="48" height="48"></div>
    <div class="titulo_head">EDITAR TALLA</div>
...
$resultado=$objempleado->consultarTallaPorParametro('id',$id_cat,'');
...
<input id="accion" name="accion" value="modificar" type="hidden">
    ...
    <legend>Detalles de talla</legend>
