...
<div class="block">
    ...
    <tr>
        <td width="100" class="key">RFC:</td>
        <td colspan="2"><input type="text" name="ruc" size="25" title="El número de RFC debe contener 13 dígitos" pattern="[0-9]{13}"></td>
    <tr>
        <td width="100" class="key">INE:</td>
        <td colspan="2"><input type="text" name="dni" size="25" title="El número de INE debe contener 18 dígitos" pattern="[0-9]{18}"></td>
    </tr>
    <tr>
