...
//------------------------------Subir Imagen_1 ----------------------------------
	...
	if ($objproducto->agregarProducto($codigobarras,$nombre,$descripcion,$stock,$stockmin,$preciocosto,$precioventa,$utilidad_total,$estado,$nombreFichero_1,$idcategoria,$idproveedor,$idcolor,$idtalla)==true)
	{
...
if ($accion=="modificar") 
{
	...
	$objproducto=new clsProducto;
	echo "apunto de guardar";
	if ($objproducto->modificarProducto($cod,$codigobarras,$nombre,$descripcion,$stock,$stockmin,$preciocosto,$precioventa,$utilidad_total,$estado,$nombreFichero_1,$idcategoria,$idproveedor,$idcolor,$idtalla)==true)
	{
...
$resultado_prov=$objproveedor->consultarProveedorPorParametro('id',$idproveedor,'');
while($row2=@mysql_fetch_array($resultado_prov))
{
	$desc_prov=$row2['Nombre'];
}

$resultado_col=$objcolor->consultarColorPorParametro('id',$idcolor,'');
while($row3=@mysql_fetch_array($resultado_col))
{
	$desc_col=$row3['Descripcion'];
}

$resultado_ta=$objtalla->consultarTallaPorParametro('id',$idtalla,'');
while($row4=@mysql_fetch_array($resultado_ta))
{
	$desc_ta=$row4['Descripcion'];
}
?>      
...
<div class="block">
    ...
    <table class="admintable">
        ...
        <tr>
            ...
            <td><?php echo $desc_prov?></td>
        </tr>

        <tr>
            <td class="key">Color:</td>
            <td><?php echo $desc_col?></td>
        </tr>

        <tr>
            <td class="key">Talla:</td>
            <td><?php echo $desc_ta?></td>
        </tr>
        <tr>
