...
$objempleado = new clsColor;
$resultado=$objempleado->consultarColorPorParametro('id',$idemp,'');
...
<div class="block">
    ...
    <div class="block_head"> 
    	<div class="imagen_head"><img src="../img/header/color.png" width="48" height="48"></div>
 ...
 <div class="toolbar" id="toolbar">
            <table class="toolbar">
            	<tbody>
                    ...
                    <td>
                    <?php
                        echo "<a class='toolbar' href=editar_color.php?idcolor=".$idcolor."><span class='icon-32-editar' title='Editar'>
                        </span>Editar</a>"; ?>
