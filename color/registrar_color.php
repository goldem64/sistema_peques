...
?>
<div class="wrapper">
    <form action="guardar_color.php" method="post" name="form1">
<div class="block">
    <div class="block_head"> 
    <div class="imagen_head"><img src="../img/header/categoria.png" width="48" height="48"></div>
    <div class="titulo_head">REGISTRAR COLOR</div>
    ...
    <div class="block_content">
        ...
        <tr>
            ...
            <td colspan="2"><input type="text" name="descripcion" id="descripcion" size="30" title="Se necesita un nombre de color"  required><input id="accion" name="accion" value="guardar" type="hidden"></td>
        </tr>
        </table>
    	</fieldset>
